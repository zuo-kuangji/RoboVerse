...
@configclass
class PsihandLeftCfg(RobotCfg):
    """Configuration for PsiHand Left (Psi-SynHand).
    ...
    name: str = "psihand_left"
    num_joints: int = 21
    fix_base_link: bool = True
    urdf_path: str = "roboverse_data/robots/psihand/urdf/psihand_left.urdf"
    mjcf_path: str = "roboverse_data/robots/psihand/mjcf/psihand_left.xml"
    usd_path: str = "roboverse_data/robots/psihand/usd/psihand_left.usd"
